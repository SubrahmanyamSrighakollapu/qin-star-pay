...
export default function RetailersPage() {
  ...
  const fetchRetailers = useCallback(
    async (activeFilters?: UserFilters, page = 1, pageSize = 10) => {
      setIsLoading(true);
      try {
        const res = await userService.getRetailers(activeFilters, page, pageSize);
  ...
  useEffect(() => {
    ...
    userService.getRetailers(filters, pagination.page, pagination.pageSize).then((res) => {
  ...
  return (
    ...
    >
      ...
      <BlockUserModal
        ...
        onSuccess={() => fetchRetailers(filters, pagination.page, pagination.pageSize)}
      />
